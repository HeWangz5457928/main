...
x  = ser.loc['2020-01-03':'202  0-01-18']
print(x)
...
x  = ser.iloc[0:2]#---series with two rowa
print(x)
...
x  = df.iloc[[0, 1]]#--OF with first two rows of df
print(x)
...
x = ser[['2020-01-02', '2020-01-03']]###first rwo rows
print(x)
